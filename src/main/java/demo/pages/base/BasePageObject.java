...
public class BasePageObject {
    ...
    public AndroidElement waitUntil(ExpectedCondition<WebElement> conditions, Integer timeout) {
        WebDriverWait wait = new WebDriverWait(getDriver(), timeout);
        return (AndroidElement) wait.until(conditions);
    }

    public AndroidElement waitUntil(ExpectedCondition<WebElement> conditions) {
    ...
    public AndroidElement waitUntilClickable(By by, Integer timeout) {
    ...
    public AndroidElement waitUntilVisible(By by, Integer timeout) {
        return waitUntil(ExpectedConditions.visibilityOfElementLocated(by), timeout);
    }

    public AndroidElement waitUntilPresent(By by) {
    ...
    public AndroidElement waitUntilPresent(By by, Integer timeoutInSeconds) {
    ...
    public AndroidElement find(String cssSelector) {
        return waitUntilPresent(By.cssSelector(cssSelector));
    }

    public void typeOn(By by, String text) {
        AndroidElement element = waitUntilVisible(by);
        element.clear();
